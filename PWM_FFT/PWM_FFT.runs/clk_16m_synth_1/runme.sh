...
HD_PWD='C:/Users/Nick Palladino/Documents/GitHub/digital-logic-project/PWM_FFT/PWM_FFT.runs/clk_16m_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_16m.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_16m.tcl
