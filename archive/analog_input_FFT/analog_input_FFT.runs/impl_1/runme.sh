...
HD_PWD='C:/Users/Nick Palladino/Documents/GitHub/digital-logic-project/analog_input_FFT/analog_input_FFT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys4_fft_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nexys4_fft_demo.tcl -notrace
