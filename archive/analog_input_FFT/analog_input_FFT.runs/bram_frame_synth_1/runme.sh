...
HD_PWD='C:/Users/Nick Palladino/Documents/GitHub/digital-logic-project/analog_input_FFT/analog_input_FFT.runs/bram_frame_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_frame.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_frame.tcl
