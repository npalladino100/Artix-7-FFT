...
HD_PWD='C:/Users/Nick Palladino/Documents/GitHub/digital-logic-project/analog_input_FFT/analog_input_FFT.runs/xadc_demo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xadc_demo.tcl
