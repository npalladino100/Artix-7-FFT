...
HD_PWD='C:/Users/Nick Palladino/Documents/GitHub/digital-logic-project/analog_input_FFT/analog_input_FFT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys4_fft_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nexys4_fft_demo.tcl
