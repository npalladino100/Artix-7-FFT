...
HD_PWD='C:/Users/Nick Palladino/Documents/GitHub/digital-logic-project/analog_input_FFT/analog_input_FFT.runs/bram_fft_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_fft.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_fft.tcl
