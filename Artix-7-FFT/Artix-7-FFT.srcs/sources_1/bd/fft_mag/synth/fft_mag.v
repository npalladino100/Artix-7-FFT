...
module fft_mag
   (clk,
    ...
    magnitude_tvalid,
    scaling);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF frame:magnitude, CLK_DOMAIN fft_mag_clk, FREQ_HZ 104000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input wire clk;
  ...
  fft_mag_axis_register_slice_2_1 axis_register_slice_2
       (.aclk(clk_1),
  ...
  fft_mag_c_addsub_0_1 c_addsub_0
       (.A(mult_gen_0_P),
        .B(mult_gen_1_P),
        .CE(1'b1),
        .S(c_addsub_0_S));
  fft_mag_cordic_0_1 cordic_0
       (.aclk(clk_1),
  ...
  fft_mag_mult_gen_0_1 mult_gen_0
       (.A(xlslice_0_Dout),
        .B(xlslice_0_Dout),
        .CLK(clk_1),
        .P(mult_gen_0_P));
  fft_mag_mult_gen_1_1 mult_gen_1
       (.A(xlslice_1_Dout),
        .B(xlslice_1_Dout),
        .CLK(clk_1),
        .P(mult_gen_1_P));
