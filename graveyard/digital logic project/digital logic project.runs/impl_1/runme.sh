...
HD_PWD='C:/Users/Nick Palladino/Documents/GitHub/digital-logic-project/digital logic project/digital logic project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log synthesizer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source synthesizer.tcl -notrace
