...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot ddr xil_defaultlib.ddr xil_defaultlib.glbl -log elaborate.log
}
