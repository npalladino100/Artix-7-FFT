...
#
# Generated by Vivado on Wed Dec 09 13:38:02 -0500 2020
...
simulate()
{
  xsim clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/fft_mag.protoinst" -log simulate.log
}
